...
// Remove some responsability, This field responsability is:
    // 1. Display the upload field (New upload / Current File+Link) 
    // 2. Delete Flag on old file if fresh is uploaded
    // 3. Run the validations on an Upload
    // 4. Get the name of the current file...

class FileUpload extends \BouletAP\Forms\AbstractField {
